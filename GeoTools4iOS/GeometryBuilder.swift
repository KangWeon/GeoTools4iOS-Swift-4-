...
class GeometryBuilder: NSObject {
    ...
    func getGeometry() -> SCNGeometry
    {
        ...
        for quad in quads
        {
            ...
            var nvf1 = SCNUtils.getNormal(v0: quad.v0, v1: quad.v1, v2: quad.v2)
            var nvf2 = SCNUtils.getNormal(v0: quad.v0, v1: quad.v2, v2: quad.v3)
            ...
            let v0 = Vertex(position: Quad.vector3ToFloat3(vector3: quad.v0), normal: Quad.vector3ToFloat3(vector3: v0norm.normalize()!), tcoord: uv0)
            let v1 = Vertex(position: Quad.vector3ToFloat3(vector3: quad.v1), normal: Quad.vector3ToFloat3(vector3: nvf1.normalize()!), tcoord: uv1)
            let v2 = Vertex(position: Quad.vector3ToFloat3(vector3: quad.v2), normal: Quad.vector3ToFloat3(vector3: v2norm.normalize()!), tcoord: uv2)
            let v3 = Vertex(position: Quad.vector3ToFloat3(vector3: quad.v3), normal: Quad.vector3ToFloat3(vector3: nvf2.normalize()!), tcoord: uv3)
